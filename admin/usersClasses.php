      ...
      "> click on new class button to add new class</span></p>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Users class History</h4>
                        </div>
                        <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <center>
                    <div class="spinner-border text-primary" role="status" id="loaderSingleUserClass" style="display: block;">
                        <span class="sr-only">Loading...</span>
                    </div>
                </center>
                <center> <div class="spinner-border text-primary" role="status" id="loaderupdateUserCat" style="display: block;">
                     <span class="sr-only">Loading...</span>
                     </div></center>

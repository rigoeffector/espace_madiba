                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Users Histroy</h4>
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills nav-secondary nav-pills-no-bd" id="pills-tab-without-border" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-profile-tab-nobd" data-toggle="pill" href="#pills-user-class-nobd" role="tab" aria-controls="pills-profile-nobd" aria-selected="false">Classes</a>
                                </li>
                            ...
                            <div class="tab-content mt-2 mb-3" id="pills-without-border-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-user-class-nobd" role="tabpanel" aria-labelledby="pills-profile-tab-nobd">
                                    <div class="d-flex align-items-center">

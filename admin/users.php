                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group ">
                                ...
                                <textarea id="userCatDescription"  class="form-control" placeholder="fill description" required></textarea>
                                <span style="color: red; display:none;" id="subscriptionDescValid">Description should not be empty</span>
                            </div>
                        </div>
                    </div>

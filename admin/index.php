...
<div class="main-panel">
	<div class="content">
		...
		<div class="page-inner mt--5">
					...
					<div class="card card-stats card-round">
						<div class="card-body ">
							<div class="row">
								...
								<div class="col-7 col-stats">
									<div class="numbers">
										<p class="card-category">Fees paid</p>
										<h4 class="card-title">RWF 100,345</h4>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-7 col-stats">
									<div class="numbers">
										...
										<h4 class="card-title" id="all_books_panel">0</h4>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="row row-card-no-pd" style="display: none;">
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							<div class="card-head-row">

			...
			<div class="page-inner py-5">
				<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
					...
					<div class="ml-md-auto py-2 py-md-0">
						<a href="#" class="btn btn-secondary btn-round" data-toggle="modal" data-target="#addNewSlider">Create Slider </a>
					</div>
				</div>
			</div>
		</div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="col-md-12">
                            <div class="container">
                                <center>
                                    <div class="spinner-border text-primary" role="status" id="loaderSlider" style="display: none;">
                                        <span class="sr-only">Loading...</span>
                                    </div>
                                </center>
                                <div class="collapse" style="display: block;">
                                    <div class="table-responsive">
                                        <table id="all_sliders-info" class="display nowrapr" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>Slider Image</th>
                                                    <th>Title</th>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p class="small">New Slider Info</p>
				<form id="newSliderForm">

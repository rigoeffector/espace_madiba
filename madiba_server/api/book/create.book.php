    ...
    if ($error > 0) {
        ...
        if (move_uploaded_file($avatar_tmp_name, $upload_name)) {
            $db_query = "INSERT INTO book
                              (title, numbers, authors, image, summary, language,
                              book_categoryId, user_classesId, isAvailable)
                               VALUES (:title,:numbers,:authors,:image,
                               :summary,:language,:book_categoryId,:user_classesId,:isAvailable)";
            ...
            $statement->bindParam(':language', $_POST['language'], PDO::PARAM_STR);
